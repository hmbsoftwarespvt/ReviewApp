        ...
        <?php if ($pagination['total_pages'] > 1): ?>
            <nav aria-label="Category apps pagination" class="mt-5">
                <ul class="pagination justify-content-center">
                    ...
                    <?php if ($start > 1): ?>
                        <li class="page-item">
                            <a class="page-link" href="<?= base_url('categories/' . esc($category['slug']) . '?page=1') ?>">1</a>
                        </li>
                        <?php if ($start > 2): ?>
                    ...
                    <?php for ($i = $start; $i <= $end; $i++): ?>
                        <li class="page-item <?= $i == $pagination['current_page'] ? 'active' : '' ?>">
                            <a class="page-link" href="<?= base_url('categories/' . esc($category['slug']) . '?page=' . $i) ?>"><?= $i ?></a>
                        </li>
                    <?php endfor; ?>
                    ...
                    <?php if ($end < $pagination['total_pages']): ?>
                        ...
                        <?php endif; ?>
                        <li class="page-item">
                            <a class="page-link" href="<?= base_url('categories/' . esc($category['slug']) . '?page=' . $pagination['total_pages']) ?>"><?= $pagination['total_pages'] ?></a>
                        </li>
                    <?php endif; ?>

                    <?php if ($pagination['current_page'] < $pagination['total_pages']): ?>
                        <li class="page-item">
                            <a class="page-link" href="<?= base_url('categories/' . esc($category['slug']) . '?page=' . ($pagination['current_page'] + 1)) ?>">
...
.trust-high { background: #10B981; }
.trust-medium { background: #F59E0B; }
